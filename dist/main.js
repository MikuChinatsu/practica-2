...
const direccion1 = new direccion_1.Direccion('Calle Principal', '123', 1, 'A', '12345', 'Ciudad', 'Provincia');
const direccion2 = new direccion_1.Direccion('Calle Secundaria', '456', 2, 'B', '54321', 'Ciudad2', 'Provincia2');
const direccion3 = new direccion_1.Direccion('Calle Tercera', '789', 3, 'C', '98765', 'Pueblo Nuevo', 'Estado Nuevo');
const telefono1 = new telefono_1.Telefono('Móvil', '1234567890');
const telefono2 = new telefono_1.Telefono('Casa', '9876543210');
const telefono3 = new telefono_1.Telefono('Trabajo', '5555555555');
const mail1 = new mail_1.Mail('Personal', 'persona1@example.com');
const mail2 = new mail_1.Mail('Trabajo', 'persona2@example.com');
const mail3 = new mail_1.Mail('Otro', 'persona3@example.com');
const persona1 = new person_1.Persona('Nombre1', 'Apellido1', 30, '123456789', new Date(), 'Azul', 'Hombre', [direccion1], [mail1], [telefono1], ['Nota 1']);
const persona2 = new person_1.Persona('Nombre2', 'Apellido2', 25, '987654321', new Date(), 'Rojo', 'Mujer', [direccion2], [mail2], [telefono2], ['Nota 2']);
const persona3 = new person_1.Persona('Nombre3', 'Apellido3', 35, '543216789', new Date(), 'Verde', 'Masculino', [direccion3], [mail3], [telefono3], ['Nota 3']);
const dniDeseado = '123456789';
const personaAModificar = [persona1, persona2, persona3].find(persona => persona.dni === dniDeseado) || null;
const nuevaDireccion = new direccion_1.Direccion('Nueva Calle', '789', 3, 'C', '54321', 'Otra Ciudad', 'Otra Provincia');
const nuevoMail = new mail_1.Mail('Otro', 'otro@example.com');
const nuevoTelefono = new telefono_1.Telefono('Trabajo', '5555555555');
